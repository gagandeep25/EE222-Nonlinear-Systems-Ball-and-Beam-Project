...
typedef struct {
  ...
  real_T MATLABSystem1;                /* '<Root>/MATLAB System1' */
...
typedef struct {
  ...
  print_discrepancies_simulink__T obj_i;/* '<Root>/MATLAB System1' */
  ...
  struct {
    void *LoggedData;
  } Discrepancies_PWORK;               /* '<Root>/Discrepancies' */
  ...
  boolean_T objisempty;                /* '<Root>/MATLAB System1' */
