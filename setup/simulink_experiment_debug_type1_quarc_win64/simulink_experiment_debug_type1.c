...
void simulink_experiment_debug_type1_output0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  t_square = -((3.0 * error + 0.0 * obj->e_integral) + 0.0 * omega_min);
...
RT_MODEL_simulink_experiment__T *simulink_experiment_debug_type1(void)
{
  ...
  /* External mode info */
  simulink_experiment_debug_ty_M->Sizes.checksums[0] = (632414910U);
  simulink_experiment_debug_ty_M->Sizes.checksums[1] = (3479197797U);
  simulink_experiment_debug_ty_M->Sizes.checksums[2] = (975574816U);
  simulink_experiment_debug_ty_M->Sizes.checksums[3] = (1037283882U);
