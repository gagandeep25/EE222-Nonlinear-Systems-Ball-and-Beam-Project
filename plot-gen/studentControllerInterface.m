classdef studentControllerInterface < matlab.System
    ...
    methods(Access = protected)
        ...
        function V_servo = stepImpl(obj, t, p_ball, theta, ampl)
        ...
        %   V_servo: voltage to the servo input.        
            ...
            [p_ball_ref, v_ball_ref, a_ball_ref] = get_ref_traj(t, ampl);
    ...
    methods(Access = public)
        ...
        % however you want.
        function [V_servo, theta_d] = stepController(obj, t, p_ball, theta, ampl)        
            V_servo = stepImpl(obj, t, p_ball, theta, ampl);
            theta_d = obj.theta_d;
        end
    end
