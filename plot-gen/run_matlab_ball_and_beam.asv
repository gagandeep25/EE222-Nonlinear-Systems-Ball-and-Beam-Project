...
for ampl=6:0.5:10
    ...
    us = [];
    theta_ds = [];
    [p_ball_ref, v_ball_ref] = get_ref_traj(t0, ampl);
    ref_ps = p_ball_ref;
    ref_vs = v_ball_ref;
    ...
    while ~end_simulation
        ...
        tstart = tic; % DEBUG    
        [u, theta_d] = controller_handle.stepController(t, x(1), x(3), ampl);
        ...
        xs = [xs, x];
        ts = [ts, t];
        [p_ball_ref, v_ball_ref] = get_ref_traj(t, ampl);
